...
#define PSU_LED_REGISTER 0xA143

//THERMAL
#define THERMAL_COUNT 26
#define THERMAL_REGISTER 0xA176
#define CHASSIS_THERMAL_COUNT 17

//ALARM
#define ALARM_REGISTER 0xA143

//LED
#define LED_COUNT   4

#define LED_SYSTEM_H  1
#define LED_SYSTEM_REGISTER 0xA144
...
#define LED_FAN_H   4
#define LED_FAN_REGISTER 0xA143
...
#define LPC_CONNECT_COME 0
#define LPC_CONNECT_CMMBMC 1
...
#define PLATFORM_PATH1 "/sys/bus/platform/devices/linecard0/SFF/"
#define PLATFORM_PATH2 "/sys/bus/platform/devices/linecard1/SFF/"
#define I2C_DEVICE_PATH "/sys/bus/i2c/devices/"
#define PREFIX_PATH_ON_SYS_EEPROM "/sys/bus/i2c/devices/i2c-0/0-0052/eeprom"

...
static int ocores_i2c_probe(struct platform_device *pdev)
{
	...
	printk(KERN_WARNING "ocores_i2c_probe,get res\n");
    printk(KERN_WARNING "pdev->name =%s,pdev->id=%x,pdev->driver_override=%s, res=%x - %x\n",pdev->name,pdev->id,pdev->driver_override,pdev->resource[0].start,pdev->resource[0].end);
